...
for asset in cr_assets_ta: #nie istniejaca nazwa
    if analysis[asset] == None:
        #print(f"nie znaleziono coin'a: {asset[8:-3]}")
        #exit()
        errors.append(asset[8:-3])

if len(errors) != 0: #wyswietlanie co jest zle
    print(f"nie znaleziono coin'a(ów): {errors}")
    exit()
